    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-200 pb-6">
          <div>
            <h1 className="text-3xl font-extrabold text-slate-800 tracking-tight">Berita Utama</h1>
            <p className="text-sm text-slate-500 mt-1">Ikuti kabar terbaru seputar kegiatan dan prestasi Pramuka SMPN 2 Katapang.</p>
          </div>
          {/* Search Input */}
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-red-500 font-semibold">Gagal memuat berita. Coba periksa koneksi Anda.</p>
          </div>
                ...
                >
                  <div>
                    ...
                    <div className="p-6 space-y-3">
                      <div className="flex items-center text-[10px] font-semibold text-slate-400 space-x-1.5">
